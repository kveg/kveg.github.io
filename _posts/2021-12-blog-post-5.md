...
___
## 引用について
引用は、基本的に自由。引用者の責任で利用してほしい。  
**引用時は出典を記載**（以下に引用例）   
・出典：青木恭子（2021）『観葉植物の顧客離脱を防ぐには 』国産花き生産流通強化推進協議会  
・出典：国産花き生産流通強化推進協議会（2021）『観葉植物の顧客離脱を防ぐには』MPSジャパン発行  
[観葉植物調査報告_本文リンク_Link_report](https://www.researchgate.net/profile/Kyoko-Aoki)  
___

## 1 概要
### (1) 概要
調査は、国産花き生産流通強化推進協議会の鉢物規格検討事業の一環。協議会から仮説と課題の提案を受け、「消費行動調査」の一部に組み込んで実施した。  
調査設計、分析、報告は筆者（青木）  
### (2) 実施方法  
...
　**図表 「虫が出るなら買わない」購入経験別（植物に興味がない人を除く n=439）**   

![「虫が出るなら買わない」購入経験別（植物に興味がない人を除く n=439）]
###### 出典：青木恭子（2021）『観葉植物の顧客離脱を防ぐには 』国産花き生産流通強化推進協議会
...
## 3 ポイント
### (1) 観葉植物の購入状況  
● 観葉植物（インドアグリーン）の購入者（回答者抽出）(Q1)（n=520）

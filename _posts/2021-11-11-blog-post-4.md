...
This "customised" survey was conducted in cooperation with the Japan Productivity Center SPRING, using the framework of the Japanese Customer Satisfaction Index (JCSI), one of the largest consumer surveys in Japan.  **Note that this flower shop survey is not an "official" JCSI survey that SPRING carries out annually.**  
